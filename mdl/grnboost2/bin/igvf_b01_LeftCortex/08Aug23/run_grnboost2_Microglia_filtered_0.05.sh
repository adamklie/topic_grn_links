...
out_dir=/cellar/users/aklie/projects/igvf/topic_grn_links/grn_inference/grnboost2/results/igvf_b01_LeftCortex/0.05/Microglia
output_dir=/cellar/users/aklie/projects/igvf/topic_grn_links/grn_inference/grnboost2/bin/igvf_b01_LeftCortex/out
error_dir=/cellar/users/aklie/projects/igvf/topic_grn_links/grn_inference/grnboost2/bin/igvf_b01_LeftCortex/err
...
cmd="sbatch \
--job-name=run_scenic_grnboost2_igvf_b01_LeftCortex_Microglia_B6J_filtered_0.05 \
...
cmd="sbatch \
--job-name=run_scenic_grnboost2_igvf_b01_LeftCortex_Microglia_CASTJ_filtered_0.05 \
--output=$output_dir/%x.%A.out \
--error=$error_dir/%x.%A.err \
--cpus-per-task=8 \
--mem-per-cpu=8G \
...
cmd="sbatch \
--job-name=run_scenic_grnboost2_igvf_b01_LeftCortex_Microglia_filtered_0.05 \
--output=$output_dir/%x.%A.out \
--error=$error_dir/%x.%A.err \
--cpus-per-task=8 \
--mem-per-cpu=8G \
