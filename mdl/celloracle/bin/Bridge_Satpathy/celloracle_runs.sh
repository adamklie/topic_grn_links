...
#SBATCH --output=/cellar/users/aklie/projects/igvf/topic_grn_links/grn_inference/celloracle/bin/Bridge_Satpathy/out/%x.%A_%a.out
#SBATCH --error=/cellar/users/aklie/projects/igvf/topic_grn_links/grn_inference/celloracle/bin/Bridge_Satpathy/err/%x.%A_%a.err
...
#####
# USAGE:
# sbatch --job-name=celloracle_Bridge_Satpathy --array=1-NUM_LINES celloracle_runs.sh $CSV_PATH
#####
